...
$cleanedName = preg_replace('/[^A-Za-z]/', '', $cleanedName);
$swearsArray = [
  "2 girls 1 cup",
  "2g1c",
  "4r5e",
...
$removedSwearsName = str_replace($swearsArray, 'happy', $cleanedName);
...
// Connection
    ...
    $result = $conn->query($query);
        ...
        $sql = "INSERT INTO Users (userId, name, email, password, timeCreated) VALUES ('$userID','$removedSwearsName','$cleanedEmail','$hashedPassword','$currentDate')";
        if ($conn->query($sql) === TRUE) {
        $_SESSION["name"] = $removedSwearsName;
        $_SESSION["email"] = $cleanedEmail;
        $_SESSION["id"] = $userID;
        // header("Location: https://willeujeans.com/64/account/");
        } else {
